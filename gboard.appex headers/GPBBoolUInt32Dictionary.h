...
+ (id)dictionaryWithValues:(const unsigned int *)arg1 forKeys:(const _Bool *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(unsigned int)arg1 forKey:(_Bool)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(_Bool)arg1;
- (void)setValue:(unsigned int)arg1 forKey:(_Bool)arg2;
...
- (_Bool)valueForKey:(_Bool)arg1 value:(unsigned int *)arg2;
...
- (id)initWithValues:(const unsigned int *)arg1 forKeys:(const _Bool *)arg2 count:(unsigned long long)arg3;
- (id)init;
