...
+ (id)dictionaryWithValues:(const float *)arg1 forKeys:(const _Bool *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(float)arg1 forKey:(_Bool)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(_Bool)arg1;
- (void)setValue:(float)arg1 forKey:(_Bool)arg2;
...
- (_Bool)valueForKey:(_Bool)arg1 value:(float *)arg2;
...
- (id)initWithValues:(const float *)arg1 forKeys:(const _Bool *)arg2 count:(unsigned long long)arg3;
- (id)init;
