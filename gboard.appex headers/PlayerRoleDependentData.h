...
@interface PlayerRoleDependentData : GPBMessage
{
}
...
@property(nonatomic) _Bool hasPlayerRole; // @dynamic hasPlayerRole;
@property(copy, nonatomic) NSString *playerRole; // @dynamic playerRole;
