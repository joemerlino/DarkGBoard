...
+ (id)dictionaryWithValues:(const long long *)arg1 forKeys:(const _Bool *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(long long)arg1 forKey:(_Bool)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(_Bool)arg1;
- (void)setValue:(long long)arg1 forKey:(_Bool)arg2;
...
- (_Bool)valueForKey:(_Bool)arg1 value:(long long *)arg2;
...
- (id)initWithValues:(const long long *)arg1 forKeys:(const _Bool *)arg2 count:(unsigned long long)arg3;
- (id)init;
