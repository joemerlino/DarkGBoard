...
@class DataFetchEntityContentList_DisplayHint, NSMutableArray;

@interface DataFetchEntityContentList : GPBMessage
{
}
...
@property(retain, nonatomic) DataFetchEntityContentList_DisplayHint *displayHint; // @dynamic displayHint;
