...
+ (id)dictionaryWithValues:(const double *)arg1 forKeys:(const _Bool *)arg2 count:(unsigned long long)arg3;
+ (id)dictionaryWithValue:(double)arg1 forKey:(_Bool)arg2;
+ (id)dictionary;
- (void)removeAll;
- (void)removeValueForKey:(_Bool)arg1;
- (void)setValue:(double)arg1 forKey:(_Bool)arg2;
...
- (_Bool)valueForKey:(_Bool)arg1 value:(double *)arg2;
...
- (id)initWithValues:(const double *)arg1 forKeys:(const _Bool *)arg2 count:(unsigned long long)arg3;
- (id)init;
