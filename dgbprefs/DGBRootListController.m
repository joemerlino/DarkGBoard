#include "DGBRootListController.h"

@implementation DGBRootListController
	...
	-(void) sendEmail{
		[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"mailto:merlino.giuseppe1@gmail.com?subject=DarkGBoard"]];
	}
	-(void) respring{
